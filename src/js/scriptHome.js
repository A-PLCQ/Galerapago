...
function tirageCard(){
    ...
    card1.style.backgroundImage = 'url(/src/assets/carteObjet/'+r1+'.jpg)';
    cardId1 = r1;
    // tirage deuxieme carte
    randomNb(); 
    let card2 = document.getElementById("card2");
    card2.style.backgroundImage = 'url(/src/assets/carteObjet/'+r1+'.jpg)';
    cardId2 = r1;
    //tirage 3eme carte
    randomNb(); 
    let card3 = document.getElementById("card3");
    card3.style.backgroundImage = 'url(/src/assets/carteObjet/'+r1+'.jpg)';
    cardId3 = r1;
}
